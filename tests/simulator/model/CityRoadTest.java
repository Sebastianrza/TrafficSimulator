...
class CityRoadTest {
	...
	void test_1() {
		...
		assertEquals(72, v2.getCurrent_speed());

		// check correctness of totoal co2
		assertEquals(266, r1.getTotal_contamination());
		assertEquals(50, v1.getTotal_contamination());
		assertEquals(216, v2.getTotal_contamination());
		...
		// check correctness of totoal co2
		assertEquals(522, r1.getTotal_contamination());
		assertEquals(100, v1.getTotal_contamination());
		assertEquals(432, v2.getTotal_contamination());
	}
