...
class InterCityRoadTest {
	...
	void test_basic_info() {
		...
		// max speed
		assertEquals(100, r1.getMaximum_speed());

		// current speed limit
		assertEquals(100, r1.getCurrent_speed_limit());

		// contamination limit
		assertEquals(500, r1.getContLimit());

		// total contamination
		assertEquals(0, r1.getTotal_contamination());
	...
	void test_1() {
		...
		// check speed
		assertEquals(50, v1.getCurrent_speed());
		assertEquals(100, v2.getCurrent_speed());

		// check correctness of total co2
		assertEquals(350, r1.getTotal_contamination());
		assertEquals(50, v1.getTotal_contamination());
		assertEquals(300, v2.getTotal_contamination());

		r1.setWeather(Weather.STORM);
		r1.advance(1);

		// speed limit changed
		assertEquals(50, r1.getCurrent_speed_limit());

		// check speed changed correctly
		assertEquals(40, v1.getCurrent_speed());
		assertEquals(40, v2.getCurrent_speed());

		// check correctness of total co2
		assertEquals(440, r1.getTotal_contamination());
		assertEquals(90, v1.getTotal_contamination());
		assertEquals(420, v2.getTotal_contamination());
	}
