...
class VehicleTest {
	...
	void getset_contamination_class() {
		...
		assertEquals(1, v1.getContamination());

		// setContClass changes the contamination class
		v1.setContamination(4);
		assertEquals(4, v1.getContamination());

		// contamination class must be between 0 and 10 (inclusive)
		assertThrows(Exception.class, () -> v1.setContamination(11));
		assertThrows(Exception.class, () -> v1.setContamination(-1));
	}
	...
	void getset_test_speed() {
		...
		assertEquals(0, v1.getCurrent_speed());
		v1.setSpeed(30);
		assertEquals(0, v1.getCurrent_speed());
		...
		v1.moveToNextRoad();
		v1.setSpeed(30);
		assertEquals(30, v1.getCurrent_speed());
